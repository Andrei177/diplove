            ...
            {(isMobile || (!isPlanshet && !isMobile)) &&
                <div className={s.main_chat_info}>
                    <div className={s.name_date}>
                        <h3 className={s.name}>{chatInfo.other_profile_first_name && chatInfo.other_profile_first_name.length > 15 ? chatInfo.other_profile_first_name.substring(0, 15) + "..." : chatInfo.other_profile_first_name}</h3>
                        ...
                        <div className={s.msg_text}>
                            {
                                chatInfo.last_message_text
                                    ? <>
                                        <h4 className={s.last_msg_name}>{chatInfo.last_message_first_name.length > 15 ? chatInfo.last_message_first_name.substring(0, 15) + "..." : chatInfo.last_message_first_name}: </h4>
